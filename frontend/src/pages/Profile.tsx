  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center dark:bg-gray-900 dark:text-white">
        ...
        <span>Загрузка вашего прогресса..</span>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">Мой прогресс</p>
            </div>
          </div>
        </div>
        ...
        {readCourses.length === 0 ? (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Нет прочитанных курсов!</h2>
            <p className="text-gray-600 dark:text-gray-400">Начни проходить курсы чтобы отслеживать свой прогресс!</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    {readParts} из {totalParts} частей пройдено
                  </p>
                </div>
              </div>
            ))}
