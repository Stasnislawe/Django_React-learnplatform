...
export function CourseCard({ course }: CourseCardProps) {
  ...
  return (
    <div onClick={handleCourseClick}>
      <div className="relative overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-shadow h-40">
        <div
        ...
        <div className="relative z-10 p-6 text-white h-full flex flex-col">
          <h3 className="text-xm font-semibold mb-2 line-clamp-2">{course.title_theory}</h3>
          <p className="text-gray-200 mb-4 line-clamp-3 flex-grow">{course.about}</p>
